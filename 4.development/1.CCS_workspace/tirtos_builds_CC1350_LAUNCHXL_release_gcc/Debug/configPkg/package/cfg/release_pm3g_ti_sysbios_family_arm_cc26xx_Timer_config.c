...
xdc_Ptr ti_sysbios_family_arm_cc26xx_Timer_Object__create__S(xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb) __attribute__ ((externally_visible));
