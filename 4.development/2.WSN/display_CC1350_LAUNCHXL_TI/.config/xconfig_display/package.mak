...
override PKGDIR = xconfig_display
...
package/%.xdc.inc package/%_xconfig_display.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_display" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em3 .dlls: display.pem3

-include package/cfg/display_pem3.mak
-include package/cfg/display_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/display_pem3.dep
endif
display.pem3: package/cfg/display_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
display.pem3 package/cfg/display_pem3.c: .libraries,em3
endif

package/cfg/display_pem3.c package/cfg/display_pem3.h package/cfg/display_pem3.xdl: override _PROG_NAME := display.xem3
package/cfg/display_pem3.c: package/cfg/display_pem3.cfg
package/cfg/display_pem3.xdc.inc: package/cfg/display_pem3.xdl
package/cfg/display_pem3.xdl package/cfg/display_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/display_pem3.cfg
	-$(RM) package/cfg/display_pem3.dep
	-$(RM) package/cfg/display_pem3.c
	-$(RM) package/cfg/display_pem3.xdc.inc

clean,em3::
	-$(RM) display.pem3
.executables,em3 .executables: display.xem3

display.xem3: |display.pem3

-include package/cfg/display.xem3.mak
display.xem3: package/cfg/display_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/display_pem3.oem3   package/cfg/display_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
display.xem3: export C_DIR=
display.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
display.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

display.test test,em3 test: display.xem3.test

display.xem3.test:: display.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 display.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.display.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,display.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
display_pem3.oem3,copy : package/cfg/display_pem3.oem3
display_pem3.sem3,copy : package/cfg/display_pem3.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_display
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_display.tar.dep
endif
package/rel/xconfig_display/xconfig_display/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_display/xconfig_display/package/package.rel.xml: package/build.cfg
package/rel/xconfig_display/xconfig_display/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_display/xconfig_display/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_display.tar: package/rel/xconfig_display.xdc.inc package/rel/xconfig_display/xconfig_display/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_display.xdc.inc,package/rel/xconfig_display.tar.dep)


release release,xconfig_display: all xconfig_display.tar
clean:: .clean
	-$(RM) xconfig_display.tar
	-$(RM) package/rel/xconfig_display.xdc.inc
	-$(RM) package/rel/xconfig_display.tar.dep
