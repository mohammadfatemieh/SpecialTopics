...
.dlls,em3 .dlls: rfWsnNode.pem3

-include package/cfg/rfWsnNode_pem3.mak
-include package/cfg/rfWsnNode_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/rfWsnNode_pem3.dep
endif
rfWsnNode.pem3: package/cfg/rfWsnNode_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
rfWsnNode.pem3 package/cfg/rfWsnNode_pem3.c: .libraries,em3
endif

package/cfg/rfWsnNode_pem3.c package/cfg/rfWsnNode_pem3.h package/cfg/rfWsnNode_pem3.xdl: override _PROG_NAME := rfWsnNode.xem3
package/cfg/rfWsnNode_pem3.c: package/cfg/rfWsnNode_pem3.cfg
package/cfg/rfWsnNode_pem3.xdc.inc: package/cfg/rfWsnNode_pem3.xdl
package/cfg/rfWsnNode_pem3.xdl package/cfg/rfWsnNode_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/rfWsnNode_pem3.cfg
	-$(RM) package/cfg/rfWsnNode_pem3.dep
	-$(RM) package/cfg/rfWsnNode_pem3.c
	-$(RM) package/cfg/rfWsnNode_pem3.xdc.inc

clean,em3::
	-$(RM) rfWsnNode.pem3
.executables,em3 .executables: rfWsnNode.xem3

rfWsnNode.xem3: |rfWsnNode.pem3

-include package/cfg/rfWsnNode.xem3.mak
rfWsnNode.xem3: package/cfg/rfWsnNode_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/rfWsnNode_pem3.oem3   package/cfg/rfWsnNode_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
rfWsnNode.xem3: export C_DIR=
rfWsnNode.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
rfWsnNode.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

rfWsnNode.test test,em3 test: rfWsnNode.xem3.test

rfWsnNode.xem3.test:: rfWsnNode.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 rfWsnNode.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.rfWsnNode.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,rfWsnNode.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
rfWsnNode_pem3.oem3,copy : package/cfg/rfWsnNode_pem3.oem3
rfWsnNode_pem3.sem3,copy : package/cfg/rfWsnNode_pem3.sem3
